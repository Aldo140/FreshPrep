...
- The built-in DB covers codes from **Jul 1, 2024 – Jul 15, 2026** (2 fiscal years).
- There are approximately **688 unique BD/EV codes** in the built-in DB.
...
*Last updated: Jul 15, 2026. Maintained alongside the codebase — update when any of the above truths change.*
